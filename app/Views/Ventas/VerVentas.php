...
$pdf->image(base_url().'Assets/img/logo.png', 70, 5, 30, 30, 'PNG');
$pdf->setFont('Arial', 'B', 10);
$pdf->Cell(50, 5, utf8_decode($config['nombre']), 0, 1, 'L');
$pdf->Cell(20, 5, utf8_decode("CI"), 0, 0, 'L');
...
$pdf->Ln();
$pdf->Cell(90, 5, 'Total Bs.'. number_format( $total, 2, '.', ','), 0, 1, 'R');
