            ...
            <div class="container-fluid d-flex align-items-center justify-content-between">
                <div class="navbar-header">
                    ...
                    <!-- Navbar Header--><a href="<?php echo base_url(); ?>Admin/Listar" class="navbar-brand">
                        <div class="brand-text brand-big visible"><strong class="text-secundary">Barraca </strong><strong class="text-white">EGON</strong></div>
                ...
                <div class="right-menu list-inline no-margin-bottom">
                    <h4>Sistema de Venta <strong class="text-primary"></strong></h4>
                </div>
                <!-- Log out               -->
                <div class="list-inline-item logout">
                    <button class="btn btn-primary" type="button" data-toggle="modal" data-target="#logout">Cerrar Sesion</button>
                </div>
            </div>
            </div>
        </nav>
